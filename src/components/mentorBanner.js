...
const MentorBanner = () => (
  <div className="p-4 sm:p-5 bg-gray-50 rounded-lg shadow-2xl flex flex-col sm:flex-row">
    <img src={illustration} alt="" className="self-center w-9/12 sm:w-1/4" />
    <div className="mt-4 sm:ml-8 sm:mt-0 space-y-3">
      ...
      <a
        ...
        className="inline-flex px-4 py-2 bg-gray-900 text-gray-100 font-bold rounded-lg items-center"
      >
        <img
