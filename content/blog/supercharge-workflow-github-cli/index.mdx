...
That's quite helpful. Most of the time, you'll use core commands. To know what you can do with each of them, provide a `--help` option. Here's an example with the `issue` command:
