...
date: "2020-03-30"
cover: "./cover.jpg"
description: "When ES2015 (also known as ES6) got released, it added great new features like **destructuring**. It allows us to unpack values from arrays or properties from objects, and it's quite powerful. Learn how to make the most of the destructuring assignment in this post."
tags: [javascript]
quick: true
---

When ES2015 (also known as ES6) got released, it added great new features like the **destructuring assignment syntax**. It allows us to unpack values from arrays or properties from objects quickly and straightforwardly.
