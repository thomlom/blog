...
date: "2020-03-18"
cover: "./cover.jpg"
description: "Making a user interface responsive is hard. It often means struggling with media queries for many hours to get a result that is barely okay. However, new CSS technologies like CSS Grid have made this task far less tedious, especially for grids."
tags: [css]
quick: true
---
